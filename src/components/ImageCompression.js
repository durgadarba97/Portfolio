    ...
    return (
        <div className={styles.root}>
                ...
                <Grid className={styles.mainGrid}>
                    <Typography gutterBottom variant="h4"> Image Compression -</Typography>
                    ...
                    <img className={styles.img} alt="imagecompression" src= {require('../images/imagecomp.png')}/>
                        ...
                        <Typography variant = {"subtitle1"}>
                            <ul>
                                <li><a style = {{color : 'white'}} href = "https://en.wikipedia.org/wiki/JPEG#JPEG_codec_example">This Wikipedia article describes it pretty well</a></li>
